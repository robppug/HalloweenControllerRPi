...
{
   public sealed partial class HWSimulated : HWInterface
   {
      ...
      public override void FireCommand(string cmd)
      {
         ...
         switch (function.Value)
         {
            ...
            case 'R': //RELAY
               ...
               UpdateUIPanel(function, subFunction, index, value);
               break;
            case 'T': //PWM
               index = UInt32.Parse(decodedData[0].ToString());
      ...
      private void UpdateUIPanel(Command function, Command subFunction, uint index, uint value)
      {
